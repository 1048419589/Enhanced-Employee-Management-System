...
public class Employee {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)//自动设置主键+1
    private int id;
    ...
    private String NIC;//身份证
    private String position;//职位
    private String department;//部门
    private String start_date;//入职日期
    private String employment_status;//在职状态
    ...
    private String isAttedence;//是否出勤

    private String isPayroll;//是否支付薪水
